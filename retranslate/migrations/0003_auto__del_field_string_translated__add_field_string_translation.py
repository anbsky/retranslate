...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'String.translated'
        db.delete_column('retranslate_string', 'translated')

        # Adding field 'String.translation'
        db.add_column('retranslate_string', 'translation',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'String.translated'
        db.add_column('retranslate_string', 'translated',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=255, db_index=True),
                      keep_default=False)

        # Deleting field 'String.translation'
        db.delete_column('retranslate_string', 'translation')
    ...
    models = {
        ...
        'retranslate.string': {
            ...
            'translation': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
