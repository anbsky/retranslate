...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('retranslate_string', (
            ...
            ('translator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('retranslate', ['String'])


    def backwards(self, orm):
        # Deleting model 'String'
        db.delete_table('retranslate_string')
