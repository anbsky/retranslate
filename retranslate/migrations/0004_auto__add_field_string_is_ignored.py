...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'String.is_ignored'
        db.add_column('retranslate_string', 'is_ignored',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'String.is_ignored'
        db.delete_column('retranslate_string', 'is_ignored')
