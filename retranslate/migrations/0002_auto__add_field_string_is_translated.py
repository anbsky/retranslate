...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'String.is_translated'
        db.add_column('retranslate_string', 'is_translated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'String.is_translated'
        db.delete_column('retranslate_string', 'is_translated')
    ...
    models = {
        ...
        'retranslate.string': {
            ...
            'translated': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
